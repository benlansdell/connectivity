function data = filters_sprc_relpos(processed, nK_sp, nK_pos, dt_sp, dt_pos)
	...
	%
	%Usage:
	%	data = filters_sprc_relpos(processed, nK_sp, nK_pos, dt_sp, dt_pos)
	%     
	%Input:
	...
	%	dt_sp = 0.002;
	%	dt_pos = 0.05;
	%	data = filters_sprc_relpos(pre.processed, nK_sp, nK_pos, dt_sp, dt_pos);
