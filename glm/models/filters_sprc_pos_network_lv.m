function data = filters_sprc_pos_network_lv(processed, nK_sp, nK_pos, dt_sp, dt_pos)
	...
	%
	%Usage:
	%	data = filters_sprc_pos_network_lv(processed, unit, nK_sp, nK_pos, dt_sp, dt_pos)
	%     
	%Input:
	...
	%	dt_sp = 0.002;
	%	dt_pos = 0.2;
	%	data = filters_sprc_pos_network_lv(pre.processed, nK_sp, nK_pos, dt_sp, dt_pos);
