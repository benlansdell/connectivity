function data = filters_sprc_pos_vel(processed, nK_sp, nK_pos, nK_vel, dt_sp, dt_pos, dt_vel)
	...
	%
	%Usage:
	%	data = filters_sprc_pos_vel(processed, nK_sp, nK_pos, dt_sp, dt_pos)
	%     
	%Input:
	...
	%	dt_pos = 0.05;
	%	dt_vel = 0.05;
	%	data = filters_sprc_pos_vel(pre.processed, nK_sp, nK_pos, nK_vel, dt_sp, dt_pos, dt_vel);
