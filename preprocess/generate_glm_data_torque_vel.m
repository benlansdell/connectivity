function processed = generate_glm_data_torque_vel(pre, k_const, k_sp, k_RU, k_FE, dt_sp, dt_pos, N, binsize, seed)
	...
	%
	%Usage:
	%	processed = generate_glm_data_torque_vel(k_sp, k_RU, k_FE, N, binsize, seed)
	%
	%Input:
	...
	%		processed = generate_glm_data_torque_vel(processed, k_sp, k_RU, k_FE, N, binsize);
	...
	data = filters_sp_vel(processed, nK_sp, nK_pos, dt_sp, dt_pos);
